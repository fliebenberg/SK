...
export const MetalText: React.FC<MetalTextProps> = ({ 
  ...
  // Adjusted heights and padding to accommodate descenders and variable length
  const sizeClasses = {
    sm: 'h-[32px] text-[18px] px-4 min-w-[60px]',
    md: 'h-[52px] text-[32px] px-8 min-w-[100px]',
    lg: 'h-[80px] text-[52px] px-10 min-w-[160px]',
    xl: 'h-[110px] text-[72px] px-12 min-w-[220px]',
  };
