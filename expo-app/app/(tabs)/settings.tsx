    ...
    >
      <View className="w-full max-w-2xl mx-auto">
        <GlassCard className="mb-6">
          <Text className="font-inter-bold text-lg text-slate-900 dark:text-white mb-4">Account</Text>
            ...
            <View className="gap-4">
              <View className="flex-row items-center gap-4">
                <View className="w-14 h-14 bg-brand-orange rounded-full items-center justify-center border border-brand-orange/30 shadow-lg shadow-brand-orange/20">
                  <Text className="font-orbitron-bold text-xl text-white">
                    {getInitials(user.name)}
                  </Text>
                </View>
                
                <View className="flex-1 justify-center">
                  <Text className="font-inter-bold text-slate-900 dark:text-white text-lg">
                    {user.name}
                  </Text>
                  ...
                  <View className="flex-row mt-1">
                    <View className="bg-brand-blue/10 border border-brand-blue/30 rounded px-2 py-0.5">
                      <Text className="font-orbitron-bold text-[10px] text-brand-blue uppercase tracking-wider">
                        {user.globalRole}
                      </Text>
                    </View>
                  </View>
              ...
              <Button 
                ...
                className="w-full md:w-auto md:self-start mt-2 md:px-8"
              />
            </View>
          ) : (
            <View className="gap-4">
        ...
        <GlassCard className="mb-6">
          <Text className="font-inter-bold text-lg text-slate-900 dark:text-white mb-4">Appearance</Text>
