---
name: Project File Maps
description: Maps common user terms to specific project files.
---

# Project File Mapping

When the user refers to the following terms, map them to these files in the project root:
